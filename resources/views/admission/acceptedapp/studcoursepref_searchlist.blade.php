...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active mt-1">Course Preferences</li>
        </ol>

        <div class="page-header">
            <form method="GET" action="{{ route('indexcoursepref_search') }}">
                {{ csrf_field() }}
        ...
        <div class="mt-5">
            <div class="">
                <table id="courseprefTableapp" class="table table-hover">
                    <thead>
                        <tr>
                            <th>App ID</th>
                            <th>Name</th>
...
<script>
    var viewallCoursePrefRoute = "{{ route('getindexcourseprefAll') }}";
