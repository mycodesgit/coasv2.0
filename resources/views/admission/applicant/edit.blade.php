                            ...
                            <div class="form-group mt-2">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="{{$applicant->lname}}" oninput="this.value = this.value.toUpperCase()"  name="lname">
                                    </div>

                                    <div class="col-md-2">
                                        <label><span class="badge badge-secondary">Firstname</span></label>
                                        <input type="text" class="form-control form-control-sm" value="{{$applicant->fname}}" oninput="this.value = this.value.toUpperCase()"  name="fname">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control form-control-sm" name="civil_status">
                                            ...
                                            <option value="Divorced" {{ $applicant->civil_status == 'Divorced' ? 'selected' : '' }}>Divorced</option>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()" name="religion" value="{{ $applicant->religion }}">
                                    </div>

                                    <div class="col-md-2">
                                        <label><span class="badge badge-secondary">Parent's Monthly Income</span></label>
                                        <input type="text" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()" name="monthly_income" value="{{ $applicant->monthly_income }}">
                                    </div>
                        ...
                        <form method="POST" action="" class="mt-3">
                            ...
                            <center>
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-5">
                                            <a href="{{ route('applicant_confirm', $applicant->id) }}" type="button" class="btn btn-primary btn-lg">
                                                <i class="fas fa-check"></i> 
                                            </a> <span style="font-size: 20pt" class="mt-2">Push to Examinee</span>
                                        </div>
                                    </div>
                                </div>
                            </center>
                    ...
                    <div class="ml-2 mr-2 mt-3 mb-1">
                        ...
                        <div class="mt-3" style="font-size: 13pt;">
                            <div class="nav flex-column nav-pills nav-stacked nav-tabs-right h-100" id="vert-tabs-right-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link" id="vert-tabs-right-two-tab" data-toggle="pill" href="#vert-tabs-right-two" role="tab" aria-controls="vert-tabs-right-two" aria-selected="true">Uploaded Docs</a>
