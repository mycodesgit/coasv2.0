...
@section('workspace')
                ...
                <div class="card" style=" background-color: #e9ecef; margin-top: -10px">
                    <div class="card-body">
                        <ol class="breadcrumb" style="margin-bottom: -3px;">
                            ...
                            <li class="breadcrumb-item active mt-1">Qualified Applicants</li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive mt-3 p-2">
                                                    <table id="allQualifiedResult" class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>App ID</th>
    ...
    <script>
        var allApplicantQualifiedResultRoute = "{{ route('getqualifiedreportsRead') }}";
    </script>
@endsection
