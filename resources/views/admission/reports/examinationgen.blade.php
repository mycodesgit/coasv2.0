...
@section('workspace')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="GET" action="{{ route('examination_reports') }}">
                                            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="">
                                                        <div class="form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <label>&nbsp;</label>
                                                                    <button type="submit" class="btn btn-success btn-sm btn-block text-light">Generate PDF</button>
                                                                </div>
                                                ...
                                                <div class="table-responsive mt-3 p-2">
                                                    <table id="allExamResult" class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>App ID</th>
    ...
    <script>
        var allApplicantExamResultRoute = "{{ route('getexaminationreportsRead') }}";
    </script>
@endsection
