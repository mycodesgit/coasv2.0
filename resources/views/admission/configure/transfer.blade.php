...
@section('workspace')
                ...
                <form id="editStudTransferForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            <label for="editStudTransferidcardno">Student ID: <span class="text0-danger">*</span></label>
                            <input type="text" class="form-control" id="editStudTransferidcardno" name="stud_id">
                        </div>
                        <div class="form-group mt-3">
                            <label for="editStudTransferName">Name: <span class="text0-danger">*</span></label>
                            <input type="text" class="form-control" id="editStudTransferName" name="">
                        </div>
                        <div class="form-group mt-3">
                            <label for="editStudTransferfromcampus">From Campus: <span class="text0-danger">*</span></label>
    ...
    <script>
        ...
        var studtransferReadRoute = "{{ route('getadstudTransferRead') }}";
    </script>
@endsection
