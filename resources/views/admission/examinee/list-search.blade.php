        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">List of Examinees</h1>
                        <p class="text-muted small mb-0">View, manage, and process examinees.</p>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-header pt-3">
                                <h6 class="card-title">
                                    <i class="ti ti-users"></i> List of Examinees Section
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive p-2">
                                    <table id="examlistTable" class="table table-hover" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>App ID</th>
                                                <th>Name</th>
