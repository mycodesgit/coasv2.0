		...
		<div class="container">
			...
			<div class="name">
				...
				<div class="result">
					...
					<div class="name-p" style="margin-left: -10px; text-decoration: underline;">{{$stanine}}</div>
					<div class="name-p" style="margin-left: 80px;">Remarks:</div>
					<div class="name-p" style="margin-left: -10px;text-decoration: underline;">{{$remarks}}</div>
				</div>
			</div>
