        ...
        <div class="mt-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{route('counterCreate')}}" id="counterad">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="mt-2 col-md-12">
                                            ...
                                            <input type="text" name="name" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()">
                                        </div>
