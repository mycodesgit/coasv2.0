                    ...
                    <div class="row" style="padding-top: 0px;">
                        <div class="col-lg-2">
                            ...
                            <div class="card">
                                ...
                                @section('sidemenulegend')
                                   <table id="tblegend" class="ml-1 mt-3 mr-1 mb-2" style="font-size: 12pt; border: 1px solid #000;">
                                        <thead>
                                           <tr>
                                               <th>Grade</th>
                                               <th>Desc.</th>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active mt-1">Grading</li>
                                        </ol>
