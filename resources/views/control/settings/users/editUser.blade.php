...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item mt-1">Users</li>
            <li class="breadcrumb-item active mt-1">Edit User</li>
        </ol>
        ...
        <div class="mt-3">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('updateUser') }}" enctype="multipart/form-data" id="classEnrollAdd">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control form-control-sm" name="dept" required="">
                                                <option disabled selected>Select</option>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('userUpdatePassword') }}" enctype="multipart/form-data" id="">
                                @csrf
                                <div class="page-header mt-3" style="border-bottom: 1px solid #04401f;">
