...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active mt-1">Enrollment Status</li>
        </ol>
                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('toggleMaintenance') }}" id="">
                        ...
                        <div class="alert alert-secondary alert-dismissible">
                                ...
                                <div class="form-row">
                                    <div class="col-8">
                                        <div class="icheck-warning">
                                            <input type="checkbox" id="maintenance" name="maintenance_mode">
                            ...
                            <span class="text-warning">Check the checkbox if you want stop Enrollment</span>
                        </div>
