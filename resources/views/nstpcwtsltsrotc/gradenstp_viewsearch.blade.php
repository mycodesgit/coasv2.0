        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">Grade Sheet</h1>
                        <p class="text-muted small mb-0">View and encode student grade in NSTP.</p>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-12">
                        <div class="card card-animate">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('gradenstp_searchlist') }}" id="gradeSht">
                                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-header d-flex justify-content-between align-items-center pt-3">
                                <h6 class="card-title">
                                    <i class="ti ti-server"></i> List of subjects per course, year & section |
                                    @if($genstud && $genstud->isNotEmpty())
                                        <strong>{{ $genstud->first()->sub_name }} {{ $genstud->first()->subSec }}</strong>
                                    @else
                                        <strong>No subjects or no students</strong>
                            ...
                            <div class="card-body">
                                <div class="table-responsive p-2">
                                    <table id="" class="table table-bordered table-head-fixed text-nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Student ID</th>
                                            ...
                                            @foreach($genstud as $datagenstud)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-success btn-sm dropdown-toggle dropdown-icon text-light" data-bs-toggle="dropdown" aria-expanded="false">
