        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="card mb-3" style=" background-color: #e9ecef; margin-top: -10px">
                    <div class="card-body">
                        <ol class="breadcrumb" style="margin-bottom: -3px;">
                            ...
                            <li class="breadcrumb-item active mt-1">CWTS Students</li>
                        </ol>
                    </div>
                </div>
                <!-- Header -->
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">CWTS Students</h1>
                        <p class="text-muted small mb-0">View student enrolled in NSTP - CWTS.</p>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-header pt-3">
                                <h6 class="card-title">
                                    <i class="ti ti-server"></i> List of NSTP - CWTS Student Section
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive p-2">
                                    <table id="cwtstab" class="table table-hover" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>1</th>
                                                <th>2</th>
