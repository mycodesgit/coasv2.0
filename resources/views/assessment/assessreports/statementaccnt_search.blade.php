        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">Student Accounts Per Semester</h1>
                        <p class="text-muted small mb-0">Show students accounts, balances per semester.</p>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-header pt-3">
                                <h6 class="card-title">
                                    <i class="ti ti-user-cog"></i> STUDENT ID NO.:</span> {{ $studfees->first()->studID }} NAME:</span> {{ $studfees->first()->fname }} {{ substr($studfees->first()->mname, 0,2) }} {{ $studfees->first()->lname }}
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
