        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="card mb-3" style=" background-color: #e9ecef; margin-top: -10px">
                    <div class="card-body">
                        <ol class="breadcrumb" style="margin-bottom: -3px;">
                            ...
                            <li class="breadcrumb-item active mt-1">HE Education Billing</li>
                        </ol>
                    </div>
                </div>
                <!-- Header -->
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">HE Billing Details</h1>
                        <p class="text-muted small mb-0">Generate and export HE billing per academic year and semester in.</p>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control form-control-sm" name="campus" id="campus">
                                                    ...
                                                    @if(Auth::user()->role == 0 || Auth::user()->id == 23)
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header pt-3">
                                <h6 class="card-title">
                                    <i class="ti ti-book"></i> List of HE Billing
                                </h6>
                            </div>
                            <div class="card-body">
