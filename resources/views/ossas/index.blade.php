        ...
        <div class="col-12">
            <div class="mb-6">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    <div>
                        <h1 class="h4 fw-bold mb-1" style="letter-spacing: -0.02em;">OSSA Dashboard Overview</h1>
                        <p class="text-muted small mb-0">Overview of student enrollment analytics, college distribution, and student welfare services.</p>
                    </div>
                </div>
