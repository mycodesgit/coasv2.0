...
@section('workspace')
                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-body p-4">
                                        ...
                                        <div class="col-12 col-md-10 col-lg-8">
                                            ...
                                            <form method="POST" action="{{ route('reset-password.send-otp') }}" id="sendOtpForm">
                                                ...
                                                <div class="d-flex flex-column flex-sm-row gap-3 justify-content-between align-items-center">
                                                    <a href="{{ route('forgot.index') }}" class="btn btn-outline-secondary w-100 w-sm-auto order-2 order-sm-1">
                                                        <i class="fas fa-arrow-left me-2"></i> Back to Reset
                                                    </a>
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('reset-password') }}" class="btn btn-link btn-sm">
    ...
    <script>
        ...
        function resendOTP() {
            ...
            .catch(error => {
                alert('Error sending OTP. Please refresh the page.');
            });
        }
        ...
        document.getElementById('resetPasswordForm')?.addEventListener('submit', function(e) {
            ...
            const strength = (password.length >= 8 && password.match(/[A-Z]/) && 
