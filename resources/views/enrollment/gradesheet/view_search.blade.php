                        ...
                        <div class="card card-animate">
                            ...
                            <div class="card-body">
                                <div class="table-responsive p-2">
                                    <table id="studentGradesTable" class="table table-bordered table-head-fixed text-nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Student ID</th>
                                        ...
                                        <tbody id="tableBodyContent">
                                            ...
                                            @foreach($genstud as $datagenstud)
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="gradeCell{{ $datagenstud->sgid }}">
                                                    ...
                                                    <td id="compCell{{ $datagenstud->sgid }}">
