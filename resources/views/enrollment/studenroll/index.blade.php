...
<div class="card">
    <div class="card-body">
        ...
        <div>
            <form method="GET" action="{{ route('searchStudEnroll') }}" enctype="multipart/form-data" id="admissionApply">
                @csrf
                ...
                <div class="form-group mt-2">
                    <div class="form-row">
                        <div class="col-md-5">
                            ...
                            <select name="stud_id" class="form-control select2" required id="searchDropdown">
                                <option disabled selected>-- Select --</option>
                                {{-- @foreach($data as $student)
                                    <option value="{{ $student->id }}">
                                        {{ $student->stud_id }} - {{ $student->lname }} {{ $student->mname }}. {{ $student->fname }}
                                    </option>
                                @endforeach --}}
                            </select>
