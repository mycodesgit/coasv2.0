    				...
    				<td class="signatories-rf-sign">
						@if(Auth::guard('web')->user()->campus == 'MC')
							...
							@elseif($progPrefix == 'CCS')
								<img src="{{ public_path('template/img/empsign/ccs.png') }}" alt="signature" style="position: absolute; margin-top: -10px; right: 550px; width: 100px; z-index: 5;">
							...
							@elseif($progPrefix == 'CAS')
								<img src="{{ public_path('template/img/empsign/cas.png') }}" alt="signature" style="position: absolute; margin-top: -5px; right: 550px; width: 100px; z-index: 5;">
							@endif
						@endif
					</td>
    				<td class="signatories-rf-sign">
						@if(Auth::guard('web')->user()->campus == 'MC')
							...
							@elseif($progPrefix == 'CCS')
								<img src="{{ public_path('template/img/empsign/ccs.png') }}" alt="signature" style="position: absolute; margin-top: -10px; right: 300px; width: 100px; z-index: 5;">
							@elseif($progPrefix == 'CBM')
							...
							@elseif($progPrefix == 'CAS')
								<img src="{{ public_path('template/img/empsign/cas.png') }}" alt="signature" style="position: absolute; margin-top: -5px; right: 300px; width: 100px; z-index: 5;">
							@endif
						@endif
					</td>
    				<td class="signatories-rf-sign">
