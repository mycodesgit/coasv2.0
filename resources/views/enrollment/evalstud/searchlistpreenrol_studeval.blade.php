...
<div class="card">
    <div class="card-body">
        ...
        <div class="page-header" style="border-bottom: 1px solid #04401f;">
            {{-- <form method="GET" action="{{ route('loadstudsub_searchview') }}" id="classEnroll">
                {{ csrf_field() }}
                ...
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                        <li class="nav-item ml-1">
                            <a class="nav-link active text-dark text-bold" id="custom-tabs-one-tab" data-toggle="pill" href="#custom-tabs-one" role="tab" aria-controls="custom-tabs-one" aria-selected="true">Student Record</a>
                        </li>
                        <li class="nav-item ml-1">
                            <a class="nav-link text-dark text-bold" id="custom-tabs-two-tab" data-toggle="pill" href="#custom-tabs-two" role="tab" aria-controls="custom-tabs-two" aria-selected="false">Load Student Subjects</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-md-2 sticky-column mt-6">
                                    <div class="card mt-2" style="background-color: #e9ecef">
                                        <div class="card-body">
                                            ...
                                            <button type="button" class="form-control form-control-sm btn btn-success btn-sm mt-2 btnprim" id="sendEmailEvalButton" disabled>Email</button>
                                        </div>
                                    </div>
