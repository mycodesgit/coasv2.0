...
@section('title')
CISS V.1.0 || Updated Enrollment Logs
@endsection
...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active mt-1">Updated Enrollment Logs</li>
        </ol>
        ...
        <div>
            <div class="page-header" style="border-bottom: 1px solid #04401f;">
                <h4>Updated Enrollment Logs</h4>
            </div> 
        </div>
            <div class="row">
                <div class="col-md-12">
                    <form method="GET" action="{{ route('search_uptadeEnrlmntlogsRead') }}" id="enrollStud">
                        @csrf   
