...
@section('title')
CISS V.1.0 || Number of Enrollees in CWTS/LTS/ROTC
@endsection
...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active mt-1">Number of Enrollees in CWTS/LTS/ROTC</li>
        </ol>
        ...
        <div>
            <div class="page-header" style="border-bottom: 1px solid #04401f;">
                <h4>Number of Enrollees in CWTS/LTS/ROTC</h4>
            </div> 
        </div>
        <div class="row">
            <div class="col-md-12">
                <form id="enrollStud" method="POST" action="{{ route('studnoenrolleenstp_searchList') }}" >
                    @csrf   
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resultModalLabel">Number of Enrolled Students in CWTS/LTS/ROTC</h5>
