...
@section('title')
CISS V.1.0 || Student Report Card
@endsection
...
<div class="card">
    <div class="card-body">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active mt-1">Student Report Card</li>
        </ol>
        ...
        <div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="GET" action="{{ route('reportCard_listsearch') }}" enctype="multipart/form-data" id="enrollStud">
                        @csrf   
                ...
                <div class="col-md-12">
                    <iframe src="{{ route('reportCard_listsearchpdf', ['stud_id' => request('stud_id'), 'schlyear' => request('schlyear'), 'semester' => request('semester')]) }}" style="width: 100%; height: 600px;" frameborder="0" class="mt-3"></iframe>
                </div>
            </div>
        </div>
