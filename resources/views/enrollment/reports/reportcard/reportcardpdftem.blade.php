...
<body>
    ...
    @foreach($subjectsData as $data)
        <tr>
            ...
            <td>{{ displayGrade($data['subject']->subjFgrade, $data['subject']->subjComp) }}</td>
            <td>{{ displayGrade($data['subject']->subjComp, null) }}</td>
