                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12"> 
                                        <form method="GET" action="{{ route('logbook_search') }}" id="enrollStud">
                                            @csrf   
                                            ...
                                            <div class="form-group mt-2">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label>Colleges: <span class="text-danger">*</span></label>
                                        ...
                                        <div class="tab-content mt-3" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="pills-two" role="tabpanel" aria-labelledby="pills-two-tab" tabindex="0">
                                                <div class="bg-light p-2 rounded-2">
                                                    <iframe src="{{ route('logbookpdfprint', ['schlyear' => request('schlyear'), 'semester' => request('semester'), 'collegeabbr' => request('collegeabbr'), 'campus' => request('campus')]) }}" width="100%" height="500"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
