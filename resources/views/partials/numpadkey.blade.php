<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active mt-2">
            ...
            <a id="btn-s" class="btn btn-app" style="border: 2px solid #252525; background-color: #ffff66 !important;">
                <i class="fas fa-s mt-1 text-dark"></i>
            </a>
            <a id="btn-m" class="btn btn-app" style="border: 2px solid #252525; background-color: #ffff66 !important;">
                <i class="fas fa-m mt-1 text-dark"></i>
            </a>
            <a id="btn-n" class="btn btn-app" style="border: 2px solid #252525; background-color: #ffff66 !important;">
                <i class="fas fa-n mt-1 text-dark"></i>
            </a>
            <a id="btn-c" class="btn btn-app" style="border: 2px solid #252525; background-color: #ffff66 !important;">
                <i class="fas fa-c mt-1 text-dark"></i>
            </a>
        </div>
