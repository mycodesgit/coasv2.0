@php
    ...
    $studsubjActive = in_array($curr_route, ['studsubjectsRead', 'listsearch_studsubjectsRead', 'listsearchgradschool_studsubjectsRead', 'listsearchview_studsubjectsRead']) ? 'active' : '';
