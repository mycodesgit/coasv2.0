<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    response.forEach(function(item) {
                        ...
                        let subjectInfo = item.sub_name + " " + item.subSec + ", " + item.room_name + " " + item.lname + " " + item.remarks;
        ...
        $('#viewSchedule').click(function() {
            ...
            mergeCellsForView();
            $('#viewRoomScheduleModal').modal('show');
        });
        ...
        $('#printSchedule').click(function() {
            ...
            // Create a form
            let form = $('<form>', {
                action: '{{ route('printRoomSchedule') }}',
                method: 'POST',
                target: '_blank'
            });
