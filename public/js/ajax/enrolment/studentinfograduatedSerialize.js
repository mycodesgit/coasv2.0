    ...
    var dataTable = $('#studinfoallgrad').DataTable({
        ...
        "columns": [
            ...
            data: 'stuDsid',
                render: function(data, type, row) {
                    if (type === 'display') {
                        var editLink = '<a href="#" class="btn btn-success btn-sm btn-studdataview text-light"  data-id="' + row.stuDsid + '" data-studid="' + row.stud_id + '" data-fname="' + row.fname + '" data-mname="' + row.mname + '" data-lname="' + row.lname + '" data-ext="' + row.ext + '" data-gender="' + row.gender + '" data-bday="' + row.bday + '" data-pbirth="' + row.pbirth + '" data-contact="' + row.contact + '" data-email="' + row.email + '" data-religion="' + row.religion + '" data-address="' + row.address + '" data-civil="' + row.civil_status + '" data-hnum="' + row.hnum + '" data-brgy="' + row.brgy + '" data-city="' + row.city + '" data-province="' + row.province + '" data-region="' + row.region + '" data-zcode="' + row.zcode + '" data-father="' + row.stud_father + '" data-mother="' + row.stud_mother + '" data-guardian="' + row.stud_guardian + '" data-income="' + row.monthly_income + '" data-pcontact="' + row.guardian_contact + '" data-lstschattended="' + row.lstsch_attended + '" data-lstschattendedyear="' + row.lst_sch_attended_year + '" data-suclstattended="' + row.suc_lst_attended + '" data-dateadmission="' + row.date_admission + '" data-spouseparent="' + row.spouseparent + '" data-elementary="' + row.elementary + '" data-elemyeargrad="' + row.elemyeargrad + '" data-highschool="' + row.highschool + '" data-highschoolyeargrad="' + row.highschoolyeargrad + '" data-tertiary="' + row.tertiary + '" data-tertiaryyeargrad="' + row.tertiaryyeargrad + '" data-tertiary="' + row.tertiary + '" data-tertiaryyeargrad="' + row.tertiaryyeargrad + '" data-tertiarycourse="' + row.tertiarycourse + '" data-tertiarymajor="' + row.tertiarymajor + '">' +
...
$(document).on('click', '.btn-studdataview', function() {
    ...
    var spouseparent = $(this).data('spouseparent');
    var elementary = $(this).data('elementary');
    var elemyeargrad = $(this).data('elemyeargrad');
    var highschool = $(this).data('highschool');
    var highschoolyeargrad = $(this).data('highschoolyeargrad');
    var tertiary = $(this).data('tertiary');
    var tertiaryyeargrad = $(this).data('tertiaryyeargrad');
    var tertiarycourse = $(this).data('tertiarycourse');
    var tertiarymajor = $(this).data('tertiarymajor');
    ...
    $('#viewdatastudSpouseParent').val(spouseparent);
    $('#viewdatastudElem').val(elementary);
    $('#viewdatastudElemgradyear').val(elemyeargrad);
    $('#viewdatastudHighschool').val(highschool);
    $('#viewdatastudHighgradyear').val(highschoolyeargrad);
    $('#viewdatastudTertiary').val(tertiary);
    $('#viewdatastudTergradyear').val(tertiaryyeargrad);
    $('#viewdatastudtertiarycourse').val(tertiarycourse);
    $('#viewdatastudtertiarymajor').val(tertiarymajor);
