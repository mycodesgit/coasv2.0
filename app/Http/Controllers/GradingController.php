...
class GradingController extends Controller
{
    ...
    public function gradesstud($subjID) 
    {
        ...
        return view('grading.gradesheet.viewstudgrade', compact('gradeviewData', 'cursttngs', 'grdCode', 'totalSearchResults', 'grade', 'grdlegend'));
    }
    ...
    public function save_grades(Request $request)
    {
        ...
        $gradeup = Grade::join('coasv2_db_schedule.sub_offered', 'studgrades.subjID', '=', 'coasv2_db_schedule.sub_offered.id')
            ...
            ->update([
                ...
                'studgrades.status' => empty($grade) ? null : 1,
                'studgrades.creditEarned' => empty($grade) ? 0 : \DB::raw('coasv2_db_schedule.sub_offered.subUnit'),
            ]);
