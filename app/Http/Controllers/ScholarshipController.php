...
class ScholarshipController extends Controller
{
    ...
    public function studscholar_searchRead(Request $request)
    {
        ...
        return view('scholar.list.listsearch_studscholar', compact('data', 'totalSearchResults'));
    }
    ...
    //     $data = StudEnrolmentHistory::leftJoin('db_schedule.programs', 'program_en_history.progCod', '=', 'db_schedule.programs.progCod')
    //             ->join('students', 'program_en_history.studentID', '=', 'students.stud_id')
    //             ->join('db_scholarship.scholarship', 'program_en_history.studSch', '=', 'db_scholarship.scholarship.id')
    //             ->join('db_scholarship.chedscholarship', 'db_scholarship.scholarship.chedcategory', '=', 'db_scholarship.chedscholarship.id')
    //             ->join('db_scholarship.universityscholar', 'db_scholarship.scholarship.unicategory', '=', 'db_scholarship.universityscholar.id')
    //             ->join('db_assessment.student_appraisal', 'program_en_history.studentID', '=', 'db_assessment.student_appraisal.studID')
    //             ->where('program_en_history.schlyear', $schlyear)
    //             ->where('program_en_history.semester', $semester)
    //             ->where('program_en_history.campus', $campus)
    //             ->where('db_assessment.student_appraisal.account', 'LIKE', '%TUITION-%')
    //             ->select('db_schedule.programs.progCod', 'db_schedule.programs.progName', 'db_schedule.programs.progAcronym', 'program_en_history.studYear', 'program_en_history.studYear', 'program_en_history.studSec', 'program_en_history.studentID', 'students.lname', 'students.fname', 'program_en_history.studYear', 'program_en_history.studSec', 'db_scholarship.scholarship.scholar_name', 'db_scholarship.scholarship.scholar_sponsor', 'db_scholarship.chedscholarship.chedsch_name', 'db_scholarship.universityscholar.unisch_name', 'db_assessment.student_appraisal.amount')
    //             ->orderBy('students.lname', 'ASC')
    //             ->get();
