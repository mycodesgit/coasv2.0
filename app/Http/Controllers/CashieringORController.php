...
class CashieringORController extends Controller
{
    ...
    public function listsearch_orRead(Request $request)
    {
        ...
        $studAccntap = AccountAppraisal::whereIn('id', ['2', '7', '33', '42', '44', '49', '74', '76', '79', '85', '90', '91', '92', '93', '99', '118', '133', '134', '151', '152', '153', '154', '155', '156', '159', '161', '70', '71', '144', '169', '24', '25', '170', '171', '172', '19', '173', '174', '175', '176'])
    ...
    public function listsearchedit_orRead(Request $request)
    {
        ...
        $orstud = Student::join('coasv2_db_assessment.studpayment', 'students.stud_id', '=', 'coasv2_db_assessment.studpayment.studID')
                ...
                ->get();
        $studfund = Funds::orderBy('id', 'DESC')->get();
        $studAccntap = AccountAppraisal::whereIn('id', ['2', '7', '33', '42', '44', '49', '74', '76', '79', '85', '90', '91', '92', '93', '99', '118', '133', '134', '151', '152', '153', '154', '155', '156', '159', '161', '70', '71', '144', '169', '24', '25', '170', '171', '172', '19', '173', '173', '174', '175', '176'])
                    ->orderBy('account_name', 'ASC')
                    ->get();
