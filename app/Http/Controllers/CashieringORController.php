...
class CashieringORController extends Controller
{
    ...
    public function listsearch_orRead(Request $request)
    {
        ...
        $studAccntap = AccountAppraisal::whereIn('id', ['2', '7', '33', '42', '44', '49', '74', '76', '79', '85', '90', '91', '92', '93', '99', '118', '133', '134', '151', '152', '153', '154', '155', '156', '159', '161', '71', '144', '169', '24', '25', '170', '171'])
